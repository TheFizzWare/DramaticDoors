...
public abstract class BaseLootTableProvider extends LootTableProvider {
    ...
    protected LootTable.Builder createStandardDoorTable(String name, Block block) {
        LootPool.Builder builder = LootPool.builder()
//                .name(name)
                .rolls(ConstantRange.of(1))
                .addEntry(ItemLootEntry.builder(block)
                        ...
                        .acceptCondition(BlockStateProperty.builder(block).with(DoorBlockStateProperties.TRIPLE_BLOCK_THIRD, TripleBlockPart.LOWER))
                );
        return LootTable.builder().addLootPool(builder);
    }
    ...
    public String getName() {
        return "DramaticDoors LootTables";
    }
}
